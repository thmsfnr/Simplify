...
package project.presentation.frame.opinion;
 ...
 */
public class CreateOpinion extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("CreateOpinionFrame.fxml"));

        // Create the scene with the root and set the title of the stage
        stage.setTitle("Creation Opinion");
