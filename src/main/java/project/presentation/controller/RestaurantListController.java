...
import project.presentation.frame.RestaurantForm;
...

                    {
                        btn.setOnAction((javafx.event.ActionEvent event) -> {
                            try{
                                ...
                                FXMLLoader loader = new FXMLLoader(project.presentation.frame.RestaurantForm.class.getResource("RestaurantFormFrame.fxml"));
...

                    {
                        btn.setOnAction((javafx.event.ActionEvent event) -> {
                            ...
                            try {
                                ...
                                Window owner = btn.getScene().getWindow();
                                FXMLLoader loader = new FXMLLoader(project.presentation.frame.RestaurantInfos.class.getResource("RestaurantInfosFrame.fxml"));
                                Parent root = loader.load();
