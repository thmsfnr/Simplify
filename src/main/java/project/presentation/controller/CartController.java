...
public class CartController implements Initializable {
    ...
    public void initialize(java.net.URL location, java.util.ResourceBundle resources) {
        ...
        this.isVisible = true;
        try {
            AnchorPane pane = FXMLLoader.load(project.presentation.frame.CartFrame.class.getResource("CartReservationComponent.fxml"));
    ...
    public void switchToDeliveryCartFrame() {
        try {
            AnchorPane pane = FXMLLoader.load(project.presentation.frame.CartFrame.class.getResource("CartDeliveryComponent.fxml"));
            cartContentArea.setContent(pane);
        } catch (IOException e) {
            e.printStackTrace();
        }
