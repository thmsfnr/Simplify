...
import project.presentation.frame.DeliveryInfo;
...

                    {
                        btn.setOnAction((ActionEvent event) -> {
                            try{
                                ...
                                FXMLLoader loader = new FXMLLoader(project.presentation.frame.DeliveryInfo.class.getResource("DeliveryInfoFrame.fxml"));
