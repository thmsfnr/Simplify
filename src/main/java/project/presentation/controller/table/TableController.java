...
public class TableController implements Initializable {
    ...
    public void initialize(java.net.URL location, java.util.ResourceBundle resources) {
        Parent root = null;
        try {
            root = FXMLLoader.load(Table.class.getResource("CreateTableComponent.fxml"));
        } catch (IOException e) {
    ...
    public void CreateTableRoute() throws IOException {
        ...
        Parent root = FXMLLoader.load(Table.class.getResource("CreateTableComponent.fxml"));
        contentArea.getChildren().setAll(root);
    }
    ...
    public void getAllTables() throws IOException {
        ...
        Parent root = FXMLLoader.load(Table.class.getResource("AllTablesComponent.fxml"));
        contentArea.getChildren().setAll(root);
    }
}
