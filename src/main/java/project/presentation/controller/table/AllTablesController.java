...
public class AllTablesController implements Initializable {
    ...
    public void updateTable(ActionEvent event, Table data)
    {
        try{
            ...
            FXMLLoader loader = new FXMLLoader(project.presentation.frame.table.Table.class.getResource("TableDetailsUpdate.fxml"));
    ...
    public void deleteTable(ActionEvent event, Table data) {
        ...
        if (result) {
            Display.infoBox("Table deleted successfully!", null, "Success");
        } else {
    ...
    {
        try{
            FXMLLoader loader = new FXMLLoader(project.presentation.frame.table.Table.class.getResource("TableDetails.fxml"));
            Parent root = loader.load();
